  ...
  <div class="slider_active owl-carousel">
    ...
    <div class="single_slider d-flex align-items-center" style="
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-12"
            style="position: absolute; bottom: 50px; left: 50%; transform: translateX(-50%); text-align: center;">
...
<div id="congratulationsModal" class="modal">
  <div class="modal-content">
    ...
    <p>Kepada seluruh civitas akademika, kami ucapkan selamat atas terakreditasinya Program Studi kami. Semoga ini
      menjadi langkah awal untuk mencapai prestasi yang lebih baik di masa depan.</p>
  </div>
</div>
  ...
  <div class="caption-container">
    ...
    <div class="row">
      <?php
        ...
        foreach ($header as $row): ?>
      <div class="column">
        <img class="demo cursor" src="<?= $base_url ?>/admin/uploads/<?= $row['file_galery_photo'] ?>"
          style="width:100%" onclick="currentSlide(<?= $slideNumber ?>)" alt="<?= htmlspecialchars($row['caption']) ?>">
      </div>
      <?php
          $slideNumber++;
        endforeach; ?>
